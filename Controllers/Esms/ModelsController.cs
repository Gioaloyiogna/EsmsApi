...
public class ModelsController : BaeApiController<ModelsController>
{
  ...
  {
    if (_context.Models == null) return Problem("Entity set 'EnpDBContext.Models'  is null.");
    ...
    if (imageFile != null)
      try
      {
        ...
        using (var fileStream =
               System.IO.File.Create(webHostEnvironment.WebRootPath + "\\Uploads\\" + imageFile.FileName))
        {
