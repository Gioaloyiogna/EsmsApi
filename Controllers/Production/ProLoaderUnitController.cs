...
public class ProLoaderUnitController : BaeApiController<ProLoaderUnitController>
{
    ...
    public async Task<ActionResult<ProloaderUnit>> Create(ProLoaderUnitPostDto proLoaderUnitPostDto)
    {
        ...
        if (ProloaderUnitExists(proloaderUnit.EquipmentId, proloaderUnit.TenantId))
        {
            return Conflict();
        }
    ...
    private bool ProloaderUnitExists(string equipmentId, string tenantId)
    {
        return _context.ProloaderUnits.Any(e =>
